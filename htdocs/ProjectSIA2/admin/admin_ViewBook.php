...
<div class="container">
    <div class="row" style="margin-top:3%">
        ...
        <div class="col s5">
            ...
            <a href="/ProjectSIA2/admin/Admin_ReadBorrow.php?book_id=<?php echo $book_id; ?>" class="btn"
                style="width:100% ">borrow</a>
                <a href="/ProjectSIA2/admin/Admin_library.php" class="btn red" style="width:100%; margin-top:2%;">back</a>
        </div>
        <div class="col s7">
            <div class="row">
